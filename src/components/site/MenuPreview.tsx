...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Герovасилиу "Rose" - Солун', weight: "0.75 л", price: toEur(52.90), desc: "100% гръцки сорт Ксиномавро" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Герovасилиу "Купаж" - Солун', weight: "0.75 л", price: toEur(48.90), desc: "Мерло, Лимно, Сира" },
