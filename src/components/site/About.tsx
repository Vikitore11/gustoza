    ...
    <section id="about" className="py-20 md:py-28 bg-background">
      <div className="mx-auto max-w-6xl px-5 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
            Пресни морски продукти, внимателно подбрани съставки и рецепти, пазени с години - това е Gustoza.
          </p>         
        ...
        <div className="relative">
          <img src={img} alt="Лятна градина на Gustoza" className="rounded-2xl shadow-warm w-full h-[480px] object-cover" loading="lazy" />
